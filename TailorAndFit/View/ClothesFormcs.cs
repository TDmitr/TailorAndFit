...
namespace TailorAndFit
{
    ...
    {
        private string file = "dataClothes.bin";
        ...
        private void importToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    file = f.FileName;
                    ClothesKind.Items = ClothesKind.Deserialize(file);
                    RefreshTable();
                }
            }
            catch (Exception)
        ...
        private void ClothesFormcs_FormClosing(object sender, FormClosingEventArgs e)
        {
